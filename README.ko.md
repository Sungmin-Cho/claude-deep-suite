...
| 플러그인 | 버전 | 설명 |
|---|---|---|
| [deep-work](https://github.com/Sungmin-Cho/deep-work) | 7.2.3 | Evidence-Driven Development Protocol |
...
| [deep-loop](https://github.com/Sungmin-Cho/deep-loop) | 1.20.0 | Loop Engineering control plane over the deep-suite |
| [deep-model-router](https://github.com/Sungmin-Cho/deep-model-router) | 1.4.0 | Deterministic model/effort/review router |
