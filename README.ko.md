...
구조화된 개발, 지식 관리, 자율 실험, 독립 코드 리뷰, 문서 가드닝, 하네스 진단을 위한 6개 플러그인을 Claude Code와 Codex에서 함께 쓸 수 있게 묶어 제공하는 cross-runtime 플러그인 마켓플레이스.
...
| 플러그인 | 버전 | 설명 |
|---|---|---|
| [deep-work](https://github.com/Sungmin-Cho/claude-deep-work) | 6.8.0 | Evidence-Driven Development Protocol |
...
| [deep-review](https://github.com/Sungmin-Cho/claude-deep-review) | 1.7.0 | Independent Evaluator |
...
| [deep-memory](https://github.com/Sungmin-Cho/claude-deep-memory) | 0.1.0 | Cross-project semantic operational memory |
