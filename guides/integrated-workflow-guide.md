...
> Reflects **deep-work v6.5.0**, **deep-review v1.4.0**, **deep-evolve v3.2.0**, **deep-docs v1.2.0**, **deep-wiki v1.5.0**, **deep-dashboard v1.2.0** — all 6 plugins adopt the M3 common artifact envelope (cross-plugin `run_id` chain + envelope-aware payload validation against the payload registry under `schemas/payload-registry/`). See `docs/envelope-migration.md` for envelope schema + migration guide.
