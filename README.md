...
|---|---|---|
| [deep-work](https://github.com/Sungmin-Cho/claude-deep-work) | 6.9.0 | Evidence-Driven Development Protocol — Phase 1 deep-memory recall + Phase 5 harvest recommendation |
